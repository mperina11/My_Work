...
//Player 1----------------------------------------------------------------------
list <string> row1_p1 = {"#","#","#","#","#","#","#","#","#"};  //each list is one row on the game baord
list <string> row2_p1 = {"#","#","#","#","#","#","#","#","#"};
list <string> row3_p1 = {"#","#","#","#","#","#","#","#","#"};
list <string> row4_p1 = {"#","#","#","#","#","#","#","#","#"};
list <string> row5_p1 = {"#","#","#","#","#","#","#","#","#"};
...
pair <string, string> A_ship1_p1; //Air-Craft-Carrier (3 positions)
pair <string, string> A_ship2_p1; //each pair is one ship position
pair <string, string> A_ship3_p1;

pair <string, string> D_ship1_p1; //Destroyer (2 positions)
pair <string, string> D_ship2_p1; 

pair <string, string> S_ship1_p1; //Submarine one (2 positions)
pair <string, string> S_ship2_p1;

pair <string, string> S2_ship1_p1; //Submarine two (2 positions)
pair <string, string> S2_ship2_p1;

int A_ship_H_p1 = 3;    //health of each ship
int D_ship_H_p1 = 2;
int S_ship_H_p1 = 2;
int S2_ship_H_p1 = 2;
...
pair <string, string> S2_ship2_p2;
...
int main(int argc, char** argv) {
    ...
    //Player 1 ship positions           //Player 1 ship positions
...
//    S2_ship2_p1.first  = "8";           S2_ship2_p2.first  = "2";  
//    S2_ship2_p1.second = "4";           S2_ship2_p2.second = "4";  

...
<body>
	...
	if ($conn->connect_error) {
        ...
        $sql_select="SELECT `uname`, `psw` FROM `mperina_login`;";
        ...
        $sql_d1 = "DROP TABLE IF EXISTS `mperina_session`;";
        ...
        // sql to create table
        $sql = "CREATE TABLE mperina_session (

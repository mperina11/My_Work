...
//        }        
	...
	if ($conn->connect_error) {
        ...
        $sql_d1 = "DROP TABLE IF EXISTS `mperina_login_2`;";
        ...
        // sql to create table
        $sql = "CREATE TABLE mperina_login_2 (
        ...
        $sql_d2 = "DROP TABLE IF EXISTS `mperina_user_2`;";
        if ($conn->query($sql_d2) === TRUE) {
          ...
          echo "Left alone" . $conn->error;
                ...
                // sql to create table
        $sql_2 = "CREATE TABLE mperina_user_2 (
        ...
        $sql = "INSERT INTO mperina_login_2 (uname, psw, first_name, last_name, email)
        VALUES ('$uname', '$hash_psw', '$fname', '$lname', '$email')";
        
        $sql_2 = "INSERT INTO mperina_user_2 (fname, lname, email)
